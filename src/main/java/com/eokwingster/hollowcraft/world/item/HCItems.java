...
public class HCItems {
    ...
    public static final Supplier<NailItem> NAIL = itemWithTab("nail", () -> new NailItem(
            HCTiers.NAIL, new Item.Properties().attributes(NailItem.createAttributes())));
    public static final Supplier<Item> SHADE_SPAWN_EGG = itemWithTab("shade_spawn_egg", () -> new DeferredSpawnEggItem(
